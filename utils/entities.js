const optionsMapper = [
  ...
  ['postre', 'postre|crepa|cupcake|brownie|chocolate|dessert|rebanada|pastel|panaderia|repostería|reposteria|galleta|cookie|dessert|pay|croissant|chocolat|pastry|churro'],
  ['pastel', 'cake|pastel'],
